...
## [6.5.2.1 Choice of a solution by FARE PRODUCT catalogue consultation](./corom/6.5.2.1-catalogue-offers.md)
...
## [6.5.2.2 Information on and choice of a solution for a specific trip](./corom/6.5.2.2-trip-offers.md)
...
## [6.5.2.3 Getting availability with or without reservation](./corom/6.5.2.3-getting-availability.md)
...
## [6.5.2.4 Purchase process](./corom/6.5.2.4-purchase-process.md)
...
## [6.5.2.5 Change before the travel](./corom/6.5.2.5-change-before-travel.md)
...
## [6.5.2.6 Change during the travel](./corom/6.5.2.6-change-during-travel.md)
...
## [6.5.2.7 Customer account consultation](./corom/6.5.2.7-customer-account-consultation.md)
...
## to do
## [BUC1 Catalogue consultation](/business-use-cases/BUC1_Catalogue-consultation.md)
