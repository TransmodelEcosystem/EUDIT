...
5. Either the TRANSPORT CUSTOMER or the RETAILER starts the catalogue consultation on behalf of the Transport Customer. The Retailer System performs **Browse catalogue** to retrieve an initial set of candidate FARE PRODUCT(s) and SALES OFFER PACKAGE(s) in its.
