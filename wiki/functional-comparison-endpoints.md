...
| Operation | OSDM 3.7.1 | TOMP-API 2.0.0 | TOMP-API-MP 2.0.0 | OMSA 0.1.0 | BoB (full suite) | FerryGateway 1.3.1 |
|-----------|-----------|---------------|------------------|-----------|-----------------|-------------------|
...
| B2B payment request (TO→MP callback) | — | — | `POST /processes/request-payment/execution` | — | — | — |
| B2B purchase confirmation request (TO→MP) | — | — | `POST /processes/request-confirmation/execution` | — | — | — |
...
| Operation | OSDM 3.7.1 | TOMP-API 2.0.0 | TOMP-API-MP 2.0.0 | OMSA 0.1.0 | BoB (full suite) | FerryGateway 1.3.1 |
|-----------|-----------|---------------|------------------|-----------|-----------------|-------------------|
| Operational notification (TO→MP) | — | — | `POST /processes/notification/execution` | — | — | — |
...
* **TOMP-API** uses OGC API Processes + Features: `POST /processes/{operation}/execution` for
  state-changing calls; `GET /collections/{resource}/items` for read-only collections.
* **TOMP-API-MP** (v2.0.0) is the reverse callback channel (TO→MP). It has three endpoints only.
